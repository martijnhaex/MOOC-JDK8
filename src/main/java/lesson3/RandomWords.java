...
public class RandomWords {
    ...
    public RandomWords() throws IOException {
        try (BufferedReader reader = Files.newBufferedReader(Paths.get("src/main/resources/words.txt"))) {
    ...
    public List<String> createList(int listSize) {
        ...
        List<String> wordList = rand.ints(listSize, 0, sourceWords.size()).boxed().map(sourceWords::get).collect(Collectors.toList()); // YOUR CODE HERE
